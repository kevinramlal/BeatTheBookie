%##need to rewrite this in python 
...
for gm = 1 : nGames
    ...
    % #marg in the paper was 0.5 page 7 
    earn_margin(1) = ((1 ./ averages(1) - marg) * maximums(1) - 1) * (counts(1) > nValidOdds) ; %#flag if counts > nValidOdds
    ...
    if sum(earn_margin > 0) >= 1
        ...
        possible_earn = bet  * (maximums(bet_result) - 1); %index
