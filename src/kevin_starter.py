...
def btb_analysis(data):
	...
	# 3. match date
	# 4. home team
	# 5. final score of home team
	# 6. away team
	# 7. final score of away team
...
data.columns = [u'match_id', u'league', u'match_date', u'home_team', u'home_score',
	...
	plt.plot(acc_home, bin_odds_home_mean, '.k', label = 'Act. Home vs Mean Home')
	plt.plot(acc_draw, bin_odds_draw_mean, '.r', label = 'Act. Draw vs Mean Draw')
	plt.plot(acc_away, bin_odds_away_mean, '.b', label = 'Act. Away vs Mean Away')
	plt.legend()
	plt.show()
	...
	return home_preds,draw_preds,away_preds
